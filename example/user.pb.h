...
PROTOBUF_NAMESPACE_OPEN
template<> ::xiong::LoginRequest* Arena::CreateMaybeMessage<::xiong::LoginRequest>(Arena*);
template<> ::xiong::LoginResponse* Arena::CreateMaybeMessage<::xiong::LoginResponse>(Arena*);
template<> ::xiong::ResultCode* Arena::CreateMaybeMessage<::xiong::ResultCode>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace xiong {
...
class ResultCode final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xiong.ResultCode) */ {
 public:
...
class LoginRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xiong.LoginRequest) */ {
 public:
...
class LoginResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xiong.LoginResponse) */ {
 public:
...
inline const ::xiong::ResultCode& LoginResponse::_internal_result() const {
  ...
  return p != nullptr ? *p : reinterpret_cast<const ::xiong::ResultCode&>(
      ::xiong::_ResultCode_default_instance_);
}
inline const ::xiong::ResultCode& LoginResponse::result() const {
...
inline ::xiong::ResultCode* LoginResponse::_internal_mutable_result() {
  ...
  if (_impl_.result_ == nullptr) {
    auto* p = CreateMaybeMessage<::xiong::ResultCode>(GetArenaForAllocation());
    _impl_.result_ = p;
  }
  return _impl_.result_;
}
inline ::xiong::ResultCode* LoginResponse::mutable_result() {
  ::xiong::ResultCode* _msg = _internal_mutable_result();
  // @@protoc_insertion_point(field_mutable:xiong.LoginResponse.result)
  return _msg;
}
inline void LoginResponse::set_allocated_result(::xiong::ResultCode* result) {
